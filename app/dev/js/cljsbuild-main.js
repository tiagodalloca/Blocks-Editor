...
var blocks_editor_demo = {core:{}};
blocks_editor_demo.core.path = cljs.nodejs.require.call(null, "path");
blocks_editor_demo.core.Electron = cljs.nodejs.require.call(null, "electron");
blocks_editor_demo.core.BrowserWindow = blocks_editor_demo.core.Electron.BrowserWindow;
blocks_editor_demo.core.crash_reporter = blocks_editor_demo.core.Electron.crashReporter;
blocks_editor_demo.core.Os = cljs.nodejs.require.call(null, "os");
blocks_editor_demo.core._STAR_win_STAR_ = cljs.core.atom.call(null, null);
blocks_editor_demo.core.app = blocks_editor_demo.core.Electron.app;
blocks_editor_demo.core._main = function() {
  blocks_editor_demo.core.crash_reporter.start(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "companyName", "companyName", 2030952346), "MrDallOca", new cljs.core.Keyword(null, "submitURL", "submitURL", -169159433), "nope"], null)));
  cljs.nodejs.process.on("error", function(a) {
    return console.log(a);
  });
  blocks_editor_demo.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? blocks_editor_demo.core.app.quit() : null;
  });
  return blocks_editor_demo.core.app.on("ready", function() {
    cljs.core.reset_BANG_.call(null, blocks_editor_demo.core._STAR_win_STAR_, new blocks_editor_demo.core.BrowserWindow(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "width", "width", -384071477), 800, new cljs.core.Keyword(null, "height", "height", 1025178622), 600], null))));
    cljs.core.deref.call(null, blocks_editor_demo.core._STAR_win_STAR_).loadURL([cljs.core.str.cljs$core$IFn$_invoke$arity$1("file://"), cljs.core.str.cljs$core$IFn$_invoke$arity$1(blocks_editor_demo.core.path.resolve(__dirname, "../index.html"))].join(""));
    return cljs.core.deref.call(null, blocks_editor_demo.core._STAR_win_STAR_).on("closed", function() {
      return cljs.core.reset_BANG_.call(null, blocks_editor_demo.core._STAR_win_STAR_, null);
    });
  });
};
cljs.nodejs.enable_util_print_BANG_.call(null);
console.log([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Start descjop application on "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(blocks_editor_demo.core.Os.type()), cljs.core.str.cljs$core$IFn$_invoke$arity$1(".")].join(""));
cljs.core._STAR_main_cli_fn_STAR_ = blocks_editor_demo.core._main;
cljs.nodejscli = {};
